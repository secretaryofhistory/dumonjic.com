...
-   **Routine documentation**: Forms of documentation that didn’t previously exist, such as release notes (see below examples).
    -   [The GoGuardian App on Windows Release Notes](https://www.goguardian.com/product-update/the-goguardian-app-on-windows-release-notes).
    -   [Pear Deck Learning product suite release notes](https://www.peardeck.com/product-updates) (i.e., Pear Deck, Pear Assessment, Pear Start, Pear Practice).
